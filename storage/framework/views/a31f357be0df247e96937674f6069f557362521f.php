                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="<?php echo e(route('admin-agent-store')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="loan" placeholder="<?php echo e(__("Loan")); ?>" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="deduction" placeholder="<?php echo e(__("Deduction")); ?>" required="" value="">
                                    </div>
                                </div>
