...
<input type="hidden" id="headerdata" value="<?php echo e(__('Bank')); ?>">
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Banks')); ?></h4>
                    <ul class="links">
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin-bank-index')); ?>"><?php echo e(__('Banks')); ?></a>
                        </li>
                    </ul>
            </div>
        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-bank-datatables')); ?>',
               columns: [
                        { data: 'no', name: 'no' },
                        { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" data-href="<?php echo e(route('admin-bank-create')); ?>" id="add-data" data-toggle="modal" data-target="#modal1">'+
