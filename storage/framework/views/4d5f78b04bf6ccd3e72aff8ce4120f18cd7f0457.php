...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Edit Zone')); ?> <a class="add-btn" href="<?php echo e(url()->previous()); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__("Back")); ?></a></h4>
                    <ul class="links">
                    <li>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="<?php echo e(route('admin-zone-update', $data->id)); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="name" placeholder="<?php echo e(__("Zone Name")); ?>" required="" value="<?php echo e($data->name); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="rt_exp" placeholder="<?php echo e(__("RT/EXP")); ?>" required="" value="<?php echo e($data->rt_exp); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <label class="switch">
                                            <input type="checkbox" name="bet1" value="1" <?php echo e($data->bet1 == 1 ? ' checked' : ''); ?>>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <label class="switch">
                                            <input type="checkbox" name="bet2" value="1" <?php echo e($data->bet2 == 1 ? 'checked' : ''); ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <label class="switch">
                                            <input type="checkbox" name="loto" value="1" <?php echo e($data->loto == 1 ? 'checked' : ''); ?>>
                                            <span class="slider round"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                    <button class="addProductSubmit-btn" type="submit"><?php echo e(__("Update Zone")); ?></button>
                                    </div>
                                </div>
