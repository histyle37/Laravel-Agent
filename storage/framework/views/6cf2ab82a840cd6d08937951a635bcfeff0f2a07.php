            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="product-description">
                        ...
                        <form id="geniusformdata" action="<?php echo e(route('admin-bank-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" class="input-field" name="no" placeholder="<?php echo e(__("No")); ?>" required="" value="<?php echo e($data->no); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                <button class="addProductSubmit-btn" type="submit"><?php echo e(__("Update Bank")); ?></button>
                                </div>
                            </div>
