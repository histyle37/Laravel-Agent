                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="<?php echo e(route('admin-agent-update', $data->id)); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                                <h4 class="heading"><?php echo e(__('Loan')); ?> *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="loan" placeholder="<?php echo e(__("Loan")); ?>" required="" value="<?php echo e($data->loan); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                                <h4 class="heading"><?php echo e(__('Deduction')); ?> *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="deduction" placeholder="<?php echo e(__("Deduction")); ?>" required="" value="<?php echo e($data->deduction); ?>">
                                    </div>
                                </div>
